                    ...
                    <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl p-6 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-indigo-500 text-xs">Bimbingan Aktif</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl p-6 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-amber-500 text-xs">Dalam Proses</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-6">
                        ...
                        <div class="text-center group">
                            ...
                            <div class="text-3xl font-bold text-amber-700 mb-1">{{ $reviewKegiatanStats['pending'] }}</div>
                        ...
                        <div class="text-center group">
                            ...
                            <div class="text-3xl font-bold text-emerald-700 mb-1">{{ $reviewKegiatanStats['approved'] }}</div>
                        ...
                        <div class="text-center group">
                            ...
                            <div class="text-3xl font-bold text-rose-700 mb-1">{{ $reviewKegiatanStats['rejected'] }}</div>
                            ...
                            <tbody>
                                @forelse($pengajuanTerbaru as $pengajuan)
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-all duration-300">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full flex items-center justify-center mr-3">
                            ...
                            <tbody>
                                @forelse($reviewKegiatanTerbaru as $review)
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-all duration-300">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center mr-3">
