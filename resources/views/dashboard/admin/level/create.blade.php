...
@section('content')
    <div id="mainContent" class="p-6 w-auto pt-[109px] md:pt-[61px] min-h-screen bg-gray-50 transition-all duration-300 ml-64">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-bold">Tambah Level</h2>
    ...
    <script>
        // Contoh: toggle class ml-64 pada #mainContent sesuai status sidebar
        // Ganti selector dan event sesuai implementasi sidebar Anda
        document.addEventListener('DOMContentLoaded', function () {
            const mainContent = document.getElementById('mainContent');
            // Misal: sidebar toggle button punya id 'sidebarToggle'
            const sidebarToggle = document.getElementById('sidebarToggle');
            // Misal: sidebar punya class 'sidebar-collapsed' saat tertutup
