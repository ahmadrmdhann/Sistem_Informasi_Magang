            ...
            <table id="userTable"
                ...
                <thead class="bg-gradient-to-r from-blue-200 to-blue-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider border-b border-r border-gray-300">Username</th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider border-b border-r border-gray-300">Status</th>
                ...
                <tbody>
                    @forelse ($users as $index => $user)
                        <tr class="even:bg-blue-50 hover:bg-blue-100 transition-colors">
                            ...
                            <td class="px-6 py-3 text-gray-700 border-b border-r border-gray-200">{{ $user->username }}</td>
                            ...
                            <td class="px-6 py-3 text-gray-700 border-b border-r border-gray-200">{{ $user->status }}</td>
