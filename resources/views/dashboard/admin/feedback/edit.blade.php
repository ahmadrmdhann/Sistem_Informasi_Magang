        ...
        <form action="{{ route('admin.feedback.update', $form->form_id) }}" method="POST" id="feedbackForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="is_active" id="is_active"
                            ...
                            <option value="0" {{ old('is_active', $form->is_active) == '0' ? 'selected' : '' }}>Nonaktif
                            </option>
                        </select>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                    ...
                    @foreach($form->questions as $index => $question)
                        <div class="question-item border border-gray-200 rounded-lg p-4 mb-4">
                            <div class="flex justify-between items-start mb-4">
                                <h4 class="text-md font-medium text-gray-800">Pertanyaan <span
                                        class="question-number">{{ $index + 1 }}</span></h4>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="questions[{{ $index }}][question_text]"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        rows="2" required
                                        placeholder="Masukkan pertanyaan feedback">{{ $question->question_text }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="questions[{{ $index }}][question_type]"
                                        ...
                                        <option value="rating" {{ $question->question_type === 'rating' ? 'selected' : '' }}>
                                            Rating (1-10)</option>
                                        <option value="text" {{ $question->question_type === 'text' ? 'selected' : '' }}>Teks
                                            Bebas</option>
                                ...
                                <div class="options-container md:col-span-2"
                ...
                <div id="noQuestionsMessage" class="text-center py-8 text-gray-500"
                    style="display: {{ $form->questions->count() > 0 ? 'none' : 'block' }};">
