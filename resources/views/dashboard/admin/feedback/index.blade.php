...
@endsection
        ...
        @section('content')
            <div id="mainContent"
                class="p-6 transition-all duration-300 ml-64 pt-[109px] md:pt-[61px] min-h-screen bg-gray-50">
                <!-- Hero Section -->
                <div
                    class="relative bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 rounded-3xl p-8 mb-8 overflow-hidden shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mr-4 backdrop-blur-sm">
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <!-- Total Forms -->
                        <div
                            class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl p-6 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                            <div class="flex items-center">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                                    <i class="fas fa-check-circle text-white text-xl"></i>
                                </div>
                                <div>
                                    <p class="text-gray-500 text-sm font-medium">Form</p>
                                    <h4 class="font-bold text-2xl text-gray-800">
                                        {{ $forms->where('is_active', true)->count() }}
                                    </h4>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="p-8">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button
                                class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 transform"
                                id="createFormBtn">
                                ...
                                <tbody>
                                    @forelse ($forms as $index => $form)
                                                                <tr class="border-b border-gray-50 hover:bg-blue-50/50 transition-all duration-300">
                                                                    ...
                                                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                                                        <form action="{{ route('admin.feedback.toggle-status', $form->form_id) }}"
                                                                            method="POST" class="inline">
                                                                            @csrf
                                                                            @method('PATCH')
                                                                            <button type="submit" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium transition-all duration-200
                                                                                                            {{ $form->is_active
                                        ? 'bg-green-50 text-green-700 hover:bg-green-100 hover:text-green-800'
                                        : 'bg-red-50 text-red-700 hover:bg-red-100 hover:text-red-800' 
                                                                                                            }}">
                                                                                <i
                                                                                    class="fas {{ $form->is_active ? 'fa-check-circle' : 'fa-times-circle' }} mr-1.5"></i>
                                        ...
                                        <tr>
                                            <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-sm">Klik tombol "Tambah Form Feedback" untuk membuat form
                                                        pertama</p>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="bg-white rounded-lg shadow p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-gray-900">{{ $forms->sum('responses_count') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="deleteConfirmModal" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                                ...
                                <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus form feedback "<span
                                        id="formTitle"></span>"?
                        ...
                        <div id="createFormModal" tabindex="-1" aria-hidden="true"
                            class="hidden fixed inset-0 z-50 bg-gray-900/70 p-4">
                            <div
                ...
                `;
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6 px-4">
                        <!-- Form Creation Guide -->
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            <div class="p-4 bg-gradient-to-r from-blue-500 to-blue-600">
                                <div class="flex items-center">
                                    ...
                                    <h3 class="ml-3 text-base font-bold text-white">Panduan Pembuatan Form</h3>
                                </div>
                            </div>
                            <div class="p-4">
                                <ul class="space-y-3">
                                    <li class="flex items-start">
                                        ...
                                        <p class="text-gray-600 text-sm">Buat form dengan judul yang jelas dan deskriptif
                                        </p>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-green-500 mt-0.5 mr-2 text-sm"></i>
                                        <p class="text-gray-600 text-sm">Tambahkan pertanyaan yang relevan dengan tujuan
                                            evaluasi</p>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-check-circle text-green-500 mt-0.5 mr-2 text-sm"></i>
                                        <p class="text-gray-600 text-sm">Sesuaikan tipe pertanyaan dengan jenis respons yang
                                            diharapkan</p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            <div class="p-4 bg-gradient-to-r from-purple-500 to-purple-600">
                                <div class="flex items-center">
                                    ...
                                    <h3 class="ml-3 text-base font-bold text-white">Tipe Pertanyaan</h3>
                                </div>
                            </div>
                            <div class="p-4">
                                <ul class="space-y-3">
                                    <li class="flex items-start">
                                        <i class="fas fa-paragraph text-purple-500 mt-0.5 mr-2 text-sm"></i>
                                        <div>
                                            <p class="font-medium text-gray-700 text-sm">Text</p>
                                            <p class="text-xs text-gray-500">Jawaban berupa teks singkat atau panjang</p>
                                        </div>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-list text-purple-500 mt-0.5 mr-2 text-sm"></i>
                                        <div>
                                            <p class="font-medium text-gray-700 text-sm">Multiple Choice</p>
                                            <p class="text-xs text-gray-500">Pilihan jawaban yang telah ditentukan</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            <div class="p-4 bg-gradient-to-r from-green-500 to-green-600">
                                <div class="flex items-center">
                                    ...
                                    <h3 class="ml-3 text-base font-bold text-white">Pengelolaan Respons</h3>
                                </div>
                            </div>
                            <div class="p-4">
                                <ul class="space-y-3">
                                    <li class="flex items-start">
                                        <i class="fas fa-calendar-check text-green-500 mt-0.5 mr-2 text-sm"></i>
                                        <p class="text-gray-600 text-sm">Atur periode aktif form untuk mengontrol pengisian
                                        </p>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-shield-alt text-green-500 mt-0.5 mr-2 text-sm"></i>
                                        <p class="text-gray-600 text-sm">Pantau status form dan jumlah respons yang masuk
                                        </p>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-download text-green-500 mt-0.5 mr-2 text-sm"></i>
                                        <p class="text-gray-600 text-sm">Unduh dan analisis data respons yang terkumpul</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6">
                                ...
                                <p class="text-blue-700 text-sm">Form standar untuk mengevaluasi pengalaman dan pembelajaran
                                    selama magang.</p>
                            </div>
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6">
                                ...
                                <p class="text-purple-700 text-sm">Form penilaian untuk mengukur kepuasan dan performa
                                    selama
                                    program magang.</p>
                            </div>
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6">
                                ...
                                <p class="text-green-700 text-sm">Form untuk memberikan masukan dan saran perbaikan program
                                    magang.</p>
                            </div>
                        </div>
                    </div>
