...
<div id="mainContent" class="p-6 transition-all duration-300 ml-64 pt-[109px] md:pt-[61px] min-h-screen bg-gray-50">
    ...
    <div class="overflow-x-auto">
        <table id="feedbackTable" class="min-w-full bg-white border border-gray-300 border-separate border-spacing-0 rounded-xl shadow-lg overflow-hidden">
            <thead class="bg-gradient-to-r from-blue-200 to-blue-100">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider rounded-tl-xl border-b border-r border-gray-300">
                        No
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider border-b border-r border-gray-300">
                        Judul Form
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider border-b border-r border-gray-300">
                        Deskripsi
                    ...
                    <th class="px-6 py-3 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider rounded-tr-xl border-b border-gray-300">
                        Aksi
                    </th>
                </tr>
            </thead>
...
<div id="deleteConfirmModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
        ...
        <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus form feedback "<span id="formTitle"></span>"? Semua data respons akan ikut terhapus.</p>
...
<div id="createFormModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto mx-auto my-auto flex items-center justify-center min-h-screen">
        <div class="w-full">
