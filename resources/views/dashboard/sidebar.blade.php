        ...
        @if (Auth::user()->level->level_kode == 'ADM')
            <div class="mb-4">
                ...
                <a href="{{ route('user.index') }}"
                    class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-blue-50 rounded-lg transition-all duration-200 group mb-1  {{ request()->routeIs('user.index') ? 'bg-blue-50 text-blue-700 font-medium' : '' }}">
            ...
            <div class="mb-4">
                ...
                <a href="{{ route('partner.index') }}"
                    class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-blue-50 rounded-lg transition-all duration-200 group mb-1 {{ request()->routeIs('partner.index') ? 'bg-blue-50 text-blue-700 font-medium' : '' }}">
                    <div class="w-5 h-5 mr-3 text-center text-gray-500 group-hover:text-blue-600">
