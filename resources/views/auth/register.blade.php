    ...
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-200">
        <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-2xl border border-blue-100 animate-fade-in">
            <div class="flex top-6 left-6">
                <a href="{{ route('landing') }}" class="text-gray-700 hover:underline focus:underline transition font-semibold">
                    <i class="fa-solid fa-chevron-left mr-1"></i>Back to Home
                </a>
            </div>
            <div class="flex justify-center mb-4">
                <img src="{{ asset('images/logo.svg') }}" alt="Logo" class="h-8 mr-3">
            </div>
            <h2 class="text-3xl font-extrabold text-center text-gray-800 tracking-tight">Create an Account</h2>
            {{-- Error message --}}
            @if ($errors->any())
            ...
            <form class="space-y-5" method="POST" action="{{ route('register') }}">
                ...
                <div class="relative">
                    ...
                    <button type="button" tabindex="0"
                        class="absolute inset-y-0 right-2 flex items-center px-2 text-gray-400 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded"
                        onclick="togglePasswordVisibility('password', 'togglePasswordIcon1')"
                        aria-label="Show or hide password">
                        <i id="togglePasswordIcon1" class="fa-solid fa-eye"></i>
                    </button>
                </div>
                <div class="relative">
                    <label for="password_confirmation" class="block mb-1 text-sm font-semibold text-gray-700">Confirm
                        Password</label>
                    ...
                    <button type="button" tabindex="0"
                        ...
                        <i id="togglePasswordIcon2" class="fa-solid fa-eye"></i>
                    </button>
                </div>
                <button type="submit"
            ...
            <p class="text-sm text-center text-gray-600">
                ...
                <a href="{{ route('login') }}"
                    class="text-blue-600 hover:underline focus:underline focus:outline-none transition font-semibold">Login</a>
            </p>
        </div>
    </div>
    <script>
