...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-200">
        <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-2xl animate-fade-in border border-blue-100">
            ...
            <h2 class="text-3xl font-extrabold text-center text-gray-800 tracking-tight">Login to Your Account</h2>
            {{-- Error message --}}
            @if ($errors->any())
            ...
            <form class="space-y-5" method="POST" action="{{ route('login') }}" autocomplete="on">
                ...
                <div class="relative">
                    ...
                    <button type="button" tabindex="0"
                        ...
                        onclick="togglePasswordVisibility()" aria-label="Show or hide password">
            ...
            <p class="text-sm text-center text-gray-600">
                ...
                <a href="{{ route('register') }}"
                    class="text-blue-600 hover:underline focus:underline focus:outline-none transition font-semibold">Register</a>
            </p>
        </div>
    </div>
    <script>
